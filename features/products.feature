...
Background:
    Given the following products
        ...
        | toothbrush  | it's a toothbrush          | True         | 5.43    | 
...
Scenario: Create a Product
    ...
    And I set the "Description" to "it's a toothbrush"
    And I select "False" in the "Available" dropdown
    And I select "5.43" in the "Price" dropdown
    ...
    And I should see "it's a toothbrush" in the "Description" field
    And I should see "False" in the "Available" dropdown
    And I should see "5.43" in the "Price" dropdown
...
Scenario: Update a Product
    ...
    And I should see "toothbrush" in the "Name" field
    And I should see "it's a toothbrush" in the "Description" field
    When I change "Name" to "Colgate Toothbrush"
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    And I should see "Colgate Toothbrush" in the "Name" field
    When I press the "Clear" button
    And I press the "Search" button
    Then I should see the message "Success"
    And I should see "Colgate Toothbrush" in the results
